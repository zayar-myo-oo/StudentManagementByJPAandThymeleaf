...
<body>
    ...
    <div>
     <p th:text="${error}" style="color: red;"	></p>
       ...
       <form action="#" th:action="@{/UserReigster}" th:object="${user}" method="post">
            ...
            <h2 class="col-md-6 offset-md-2 mb-5 mt-4">User Registration </h2>
             ...
             <div class="row mb-4">
                ...
                <input type="text" id="name" class="form-control" required="required" th:field = *{name} >
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                 ...
                 <input type="email" id="email" class="form-control" required="required" th:field = *{email} >  
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
                <label for="password" class="col-md-2 col-form-label">Passoword</label>
                <div class="col-md-4">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                <input type="password" id="confirmPassword" class="form-control" required="required" th:field = *{confirm} > 
            ...
            <div class="row mb-4">
                ...
                <select id="userRole" class="form-select" aria-label="Education" th:field = *{role} required="required">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="button" class="btn btn-secondary col-md-2 addsubmits" data-bs-toggle="modal" data-bs-target="#exampleModal" value="Add"/>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                   ...
                                   <h5 style="color: rgb(127, 209, 131);"  id="addusersuccessfuls">Registered Succesfully !</h5>
                                </div>
        ...
        <script type="text/javascript" th:src="@{/js/updateapp.js}"></script>
        <script>
