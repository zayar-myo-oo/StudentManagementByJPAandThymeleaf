		...
		<div class="sidenav">
			...
			<div class="dropdown-container">
				<a href="/courseRegister">Course Registration </a> <a
					href="/registerStudent">Student Registration </a> <a
					href="/showuser">Student Search </a>
			</div>
				...
				<form action="#" th:action="@{/StudentRegister}"
					...
					<div class="row mb-4">
						...
						<div class="col-md-4">
							...
							<input type="date" th:field=*{dob} class="form-control" id="stuDOB"
								required="required">
					...
					<fieldset class="row mb-4">
						...
						<div class="col-md-4">
							<div class="form-check-inline">
								...
								<input type="radio" th:attr="name='gender'" th:value="male"
									checked class="form-check-input" id="stuGender"> <label
									class="form-check-label" for="stuGender"> Male </label>
							</div>
							<div class="form-check-inline">
								<input type="radio" th:attr="name='gender'" th:value="female"
									class="form-check-input" id="stuGender"> <label
					...
					<div class="row mb-4">
						...
						<div class="col-md-4">
							...
							<select class="form-select" aria-label="Education" id="stuEdu"
								th:field=*{education} required="required">
								<option th:value="BachelorofInformationTechnology">Bachelor
									of Information Technology</option>
								<option th:value="DiplomainIT">Diploma in IT</option>
								<option th:value="BachelorofComputerScience">Bachelor
					...
					<fieldset class="row mb-4">
						...
						<div class="col-md-4">
							...
							<div class="form-check-inline col-md-3"
								th:each="c : ${session.course}">


								<input type="checkbox" th:field=*{attend} 
									th:value="${c.cid+'-'+c.name}" class="form-check-input"
									id="stuCourse"> <label class="form-check-label"
									for="stuCourse" th:text="${c.name}"> </label>
							</div>
								...
								<div class="modal-dialog modal-dialog-centered">
									<div class="modal-content">
										...
										<div class="modal-body">
											<h5 style="color: rgb(127, 209, 131); " id="addusersuccessfuls">Registered
												Succesfully !</h5>
										</div>
